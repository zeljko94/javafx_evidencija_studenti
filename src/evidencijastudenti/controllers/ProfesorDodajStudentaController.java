...
public class ProfesorDodajStudentaController implements Initializable {
    ...
    public void btnNazadOnClick(){
        evidencijastudenti.EvidencijaStudenti.openWindow("Profesor - pregled studenata", btnDodaj.getParent(), "ProfesorPregledStudenata");
    }
