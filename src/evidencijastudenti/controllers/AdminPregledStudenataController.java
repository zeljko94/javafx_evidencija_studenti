...
public class AdminPregledStudenataController implements Initializable {
    ...
    public void btnDodajOnClick(){
        evidencijastudenti.EvidencijaStudenti.openWindow("Admin - Dodaj studenta", btnDodaj.getParent(), "AdminDodajStudenta");
    }
    ...
    public void btnIzmjeniOnClick(){
        ...
        if(user != null){
            ...
            evidencijastudenti.EvidencijaStudenti.openWindow("Admin - izmjena studenta", btnDodaj.getParent(), "AdminIzmjeniStudenta");
        }
    }
