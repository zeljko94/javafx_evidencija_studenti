...
public class AdminIzmjeniStudentaController implements Initializable {
    ...
    public void btnNazadOnClick(){
        evidencijastudenti.EvidencijaStudenti.openWindow("Admin - pregled studenata", btnIzmjeni.getParent(), "AdminPregledStudenata");
    }   
}
