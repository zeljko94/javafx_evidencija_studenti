...
public class AdminDodajProfesoraController implements Initializable {
                    ...
                    if(!password.equals("")){
                        if(!rePassword.equals("")){
                            if(password.equals(rePassword)){
                                if(!email.equals("")){
                                    User user = new User(username, password, email, ime, prezime, "profesor", "", brojTelefona);
                                    user.insert();
                                    
                                    setSuccessText("Korisnik uspješno unesen!");
                                }
                                else{
    ...
    public void btnNazadOnClick(){
        evidencijastudenti.EvidencijaStudenti.openWindow("Admin - pregled profesora", btnDodaj.getParent(), "AdminPregledProfesora");
    }
